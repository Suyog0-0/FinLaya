    ...
    <>
      <div className="p-6">
        <p className="text-sm text-gray-500 mb-3">
          Toggle categories on/off, rename them, or adjust amounts. The bar shows how much of your salary is allocated.
        </p>
        ...
        {showAddRow ? (
          <div className="flex items-center gap-2 p-2.5 rounded-xl border border-dashed border-orange-300 bg-orange-50/30">
            ...
            <button
              ...
              className="text-orange-500 hover:text-orange-600 font-semibold text-xs px-2"
            >
              Add
            </button>
            <button
